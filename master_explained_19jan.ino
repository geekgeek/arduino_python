...
const int buttonPin5 = A5;     // the number of the pushbutton pin
int buttonState5 = 0;         // variable for reading the pushbutton status
//Button plate 2:
const int buttonPin6 = A4;     // the number of the pushbutton pin
int buttonState6 = 0;         // variable for reading the pushbutton status

const int buttonPin7 = A3;     // the number of the pushbutton pin
