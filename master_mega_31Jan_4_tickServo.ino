...
void sdWriteServoValue()
{
  ...
  if (myFile) 
  {
   ...
   //<write to file:> 
    myFile.print("<servo1>");
    myFile.print(String(potvalReverse));
    myFile.print("</servo1>");
...
//<>
      ...
      while (digitalRead(buttonPin2) == LOW) 
      {
          ...
          //<Reverse Engine>
          potvalReverse = 180 - potval;
          //</>
          
         //<Move servos to the pot values>
          servo1.write(potvalReverse);
          servo2.write(potval);
          servo3.write(potval3);  
          //</>

          //<Serial message>
          Serial.print(potvalReverse);
          Serial.print("--");
          Serial.print(potval);
          Serial.print("--");
          ...
          while (digitalRead(buttonPin10) == LOW) 
            {
               ...
               //</>
                ...
                myFile2.print(String(potvalReverse));
                myFile2.print("</servo1>");
...
void sdReadServos2()
{
  ...
  if (myFile) 
  {
    ...
    while (myFile.available()) 
    {
      ...
      //</NEW CODE>
      int arrValues[] = {readServo1 , readServo2, readServo3};
      int arrX = 0;
      int var1 = 0;

      int startVa[] = {convLine,convLine2,convLine3};
      int startX = 0;
